...
function handleBackendAuthorize(event) {
	...
	.then(backend => {
		...
		settingsPage.addEventListener('ok', function(event) {
			...
			//TODO: Когда нажимаем OK, нельзя давать повторно нажимать OK, пока работает промиз
			// Вообще всё это нужно сделать каким-то стандартным промизом для таких модалов
